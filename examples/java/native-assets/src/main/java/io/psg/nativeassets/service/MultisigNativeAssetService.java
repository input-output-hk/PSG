...
//
//    public CompletionStage<String> createMintTransactionWithArbitraryMetadata(String policyId, String assetName, String paymentAddress, String mintTargetAddress, Long amount, JsonObject json) {
